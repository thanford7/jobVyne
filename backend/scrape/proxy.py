...
class ProxyGetter:
    ...
    def __init__(self, timeout=0.5, anonym=False, elite=False, google=None, https=False):
    ...
    def is_meets_criteria(self, row_elements):
        country_criteria = True if not ALLOWED_COUNTRY_CODES else row_elements[2].text_content() in ALLOWED_COUNTRY_CODES
