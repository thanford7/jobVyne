...
PREPEND_WWW = False
ALLOWED_HOSTS = env('DJANGO_ALLOWED_HOSTS', default='127.0.0.1,localhost,0.0.0.0,backend,bdf3-174-16-122-15.ngrok-free.app').split(',')
...
LOGGING = {
    ...
    'handlers': {
        ...
        'sql': {
            'class': 'logging.StreamHandler',
            'level': 'DEBUG',  # Set LOG_LEVEL to "DEBUG" in .env file  to get Django SQL queries
            'formatter': 'msg_only',
