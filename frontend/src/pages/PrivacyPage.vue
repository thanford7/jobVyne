    ...
    <div class="row">
      <div class="col card-custom">
        ...
        <ul>
          ...
          <li>
            <p><strong>Consumer</strong>, for the purpose of the CCPA (California Consumer Privacy Act), means a natural
              person who is a California resident. A resident, as defined in the law, includes (1) every individual who
              is in the USA for other than a temporary or transitory purpose, and (2) every individual who is domiciled
              in the USA who is outside the USA for a temporary or transitory purpose.</p>
          </li>
          <li>
          ...
          <li>
            ...
            <p>For the purposes of the CCPA, Personal Data means any information that identifies, relates to, describes
          ...
          <li>
            <p><strong>Sale</strong>, for the purpose of the CCPA (California Consumer Privacy Act), means selling,
              ...
              or a third party for monetary or other valuable consideration.</p>
          </li>
          <li>
          ...
          <li>
            <p><strong>Website</strong> refers to JobVyne, accessible from <a href="https://jobvyne.com"
                                                                              rel="external nofollow noopener"
                                                                              target="_blank">https://jobvyne.com</a>
            </p>
          </li>
          <li>
        ...
        <p>When You pay for a product and/or a service via bank transfer, We may ask You to provide information to
          facilitate this transaction and to verify Your identity. Such information may include, without limitation:</p>
        <ul>
          <li>Date of birth</li>
        ...
        <p>Cookies can be &quot;Persistent&quot; or &quot;Session&quot; Cookies. Persistent Cookies remain on Your
          ...
          Your web browser. You can learn more about cookies here: <a
        ...
        <ul>
          <li>
            ...
            <p>Their Privacy Policy can be viewed at <a href="www.twilio.com/legal/privacy"
                                                        rel="external nofollow noopener" target="_blank">www.twilio.com/legal/privacy</a>
            </p>
          </li>
        </ul>
        <h6>Payments</h6>
        ...
        <ul>
          <li>
            ...
            <p>Their Privacy Policy can be viewed at <a href="https://stripe.com/us/privacy"
                                                        rel="external nofollow noopener" target="_blank">https://stripe.com/us/privacy</a>
            </p>
          </li>
        </ul>
        ...
        <p>We collect information that identifies, relates to, describes, references, is capable of being associated
          ...
          California residents within the last twelve (12) months.</p>
        <p>Please note that the categories and examples provided in the list below are those defined in the CCPA. This
          ...
          category may be and may have been collected. For example, certain categories of personal information would
        ...
        <ul>
          ...
          <li>
            ...
            <p>Examples: A name, signature, Social Security number, physical characteristics or description, address,
              ...
              personal information included in this category may overlap with other categories.</p>
            <p>Collected: Yes.</p>
          </li>
          <li>
        ...
        <ul>
          ...
          <li><strong>From Service Providers</strong>. For example, third-party vendors for payment processing, or other
        ...
        <p>Please note that the categories listed below are those defined in the CCPA. This does not mean that all
          ...
          best of our knowledge that some of that information from the applicable category may be and may have been
          shared for value in return.</p>
        ...
        <p>We do not sell the personal information of Consumers We actually know are less than 16 years of age, unless
          We receive affirmative authorization (the &quot;right to opt-in&quot;) from either the Consumer who is between
        ...
        <ul>
          ...
          <li><strong>The right to request.</strong> Under CCPA, You have the right to request that We disclose
            ...
            <ul>
              ...
              <li>If we sold Your personal information or disclosed Your personal information for a business purpose, We
          ...
          <li><strong>The right to say no to the sale of Personal Data (opt-out).</strong> You have the right to direct
          ...
          <li><strong>The right not to be discriminated against.</strong> You have the right not to be discriminated
            ...
            <ul>
              ...
              <li>Suggesting that You will receive a different price or rate for goods or services or a different level
        ...
        <p>We will disclose and deliver the required information free of charge within 45 days of receiving Your
          ...
          45 days when reasonable necessary and with prior notice.</p>
        <p>Any disclosures We provide will only cover the 12-month period preceding the verifiable request's
          receipt.</p>
